...
/***************************************************************************
  ...
  Observatório Participativo Ambiental: estação de sensoriamento de dados climáticos

  O Observatório Participativo Ambiental (OPA) é uma proposta de ciência cidadã 
  para sensoriamento participativo de elementos climáticos
  coletando dados de temperatura do ar, umidade do ar e pressão atmosférica.
  ...
  ***************************************************************************
  ...
  A Estação OPA é composta por um microcontrolador ESP8266 NodeMCU Lolin V3, e o sensor BME280.
...
Adafruit_MQTT_Publish pubTemperatura = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/opatemperatura");
Adafruit_MQTT_Publish pubUmidade = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/opaumidade");
Adafruit_MQTT_Publish pubPressao = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/opapressao");
...
void setup() {
  ...
  Serial.println(F("Iniciando o OPA..."));  // Exibe no Monitor Serial.
